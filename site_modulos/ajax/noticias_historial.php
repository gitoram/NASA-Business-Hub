...
$rowTotal = '4';   //-- total de registros a mostrar por Pagina debe se ser numero par
...
$paginas['Visibles'] 	= 6; // 4 antes, 4 despues y la actual
   ...
   <div style="overflow:hidden;" align="left">
      ...
      <div style="overflow:hidden;">
           <div class="contLeft" style="width:40%; padding-right:5px; ">
                <img src="imagen.php?archivo=<?=$row["ArchivoImagen"];?>&tipo=1&medida=2" alt="<?=$row["Titulo"];?>" border="0" class="imgFull" />
            </div>
            
            <div class="contLeft" style="width:55%">
             <? if($keyIdioma != "0" && $row["TituloIdioma"]!= ""){?>
                <div style="padding-left:3px; padding-right:2px; padding-top:3px; " class="txtTitLista"><?=limitarCadena($row["TituloIdioma"],'40',' ..');?></div>
                <div style="padding-top:2px;" align="right"><a href="publicacion.php?publicacion=<?=$row[UrlAlias];?>" class="txtLinkList">More..</a></div>
                    
            <? }else { ?>
                <div style="padding-left:3px; padding-right:2px; padding-top:3px;" class="txtTitLista"><?=limitarCadena($row["Titulo"],'40',' ..');?></div>
                <div style="padding-top:2px;" align="right"><a href="publicacion.php?publicacion=<?=$row[UrlAlias];?>" class="txtLinkList">Ver Mas..</a></div>
             <? }?>
